...
ALGORITHM_SO_FILE_FOLDER = "src/system/submodules/reconfiguration/lib/"
SOLVER_WRAPPER_SO_FILE = "build/solver.so"
    
def execute_wrapper(algorithm, initial, target, Nt_x, Nt_y):
