...
class atmcd:
  __version__ = '0.1'
  LIBRARY_NAME = 'andor'
  print("IMPORTED ATMCD")
  def __init__(self, userPath = None):   
    print("User path is ",userPath)
  ...
  def PostProcessCountConvert(self, iInputImageFirstPixel, iOutputBufferSize, iNumImages, iBaseline, iMode, iEmGain, fQE, fSensitivity, iHeight, iWidth):
    ''' 
        Description:
    ...
    '''
    cpInputImage = c_int(iInputImageFirstPixel)
    cpOutputImage = c_int()
