...
/**
* @brief Function that takes command line input and modifies the default global parameters
*/
...
int main(int argc, char * argv[]) {
    ...
    awg.configure_segment_length(Synthesis::read_waveform_duration(WFM_CONFIG_PATH("config.yml")));
    ...
    auto transfer_buffer = awg.allocate_transfer_buffer(samples_per_segment, cont_buffer);
