...
#ifndef TRAP_ARRAY_H_
#define TRAP_ARRAY_H_
...
class TrapArray {
  ...
  public:
     ...
     */
    TrapArray(int Nt_x, int Nt_y, const std::vector<int32_t> &current_config,
              double loss_params_alpha = 0, double loss_params_nu = 0,
              double lifetime = 60, int total_moves = 0);
    ...
    /**
     * @brief Function to check if a given move is in the Bounds of Trap Array
     * class
     ...
     */
    int moveAtoms(int low_Nt_x, int low_Nt_y, int block_size,
    ...
    /**
     * @brief Edit a binary vector to represent the current configuration of
     * Atoms in the Trap Array
     ...
     */
    void printTrapArray(int Nt_x1 = 0, int Nt_x2 = 0, int Nt_y1 = 0,
                        int Nt_y2 = 0);
     ...
     * @param Nt_y2 High limit of columns to print (default = 0)
     */
    void printTrapArrayBounds(int Nt_x1 = 0, int Nt_x2 = 0, int Nt_y1 = 0,
                              int Nt_y2 = 0);
