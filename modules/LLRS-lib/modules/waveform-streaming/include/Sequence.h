#ifndef _AWGSEQUENCE_H_
#define _AWGSEQUENCE_H_
...
namespace Stream {
    ...
    public:
         ...
         */
        Sequence(Util::Collector *p_collector, Synthesis::WaveformTable &wf_table): p_collector{p_collector}, wf_table{wf_table} {}


        Sequence(std::shared_ptr<AWG_T> &awg,Util::Collector *p_collector, Synthesis::WaveformTable &wf_table ): awg{awg}, p_collector{p_collector}, wf_table{wf_table} {}


        void setup(int idle_segment_idx, int idle_step_idx, bool _2d, int Nt_x, int Nt_y);
        void pre_load();
        bool load_and_stream(std::vector<Reconfig::Move> & moves_list, int trial_num, int rep_num, int cycle_num);
    ...
    private:         
        ...
        void    wf_segment_lookup(short * p_buffer_lookup, std::vector<Reconfig::Move> & moves_list, int waveforms_per_segment);
   };
