...
enum ADL_TARGET_TYPE {
   ADL_TARGET_TYPE_UNKNOWN = 0,
   ADL_TARGET_TYPE_RECT
};
...
typedef struct _ADL_POINT {int32_t x; int32_t y;} ADL_POINT;
typedef struct _ADL_RECT {int32_t x; int32_t y; int32_t width; int32_t height;} ADL_RECT;
...
#define ADL_ARGB(a,r,g,b) ((uint32_t)((((a)&0xff)<<24)|(((r)&0xff)<<16)|(((g)&0xff)<<8)|((b)&0xff)))
...
typedef struct IADL_Image {
   ...
   virtual err_t _CALLTYPE_C SetAttribute (enum ADL_IMAGE_ATTRIBUTE Attribute, ADL_ATTRIBUTE_TYPE Arg)   = 0;
   virtual err_t _CALLTYPE_C GetAttribute (enum ADL_IMAGE_ATTRIBUTE Attribute, ADL_ATTRIBUTE_TYPE Arg)   = 0;
} IADL_Image;
...
struct IADL_ImageVtbl {
   ...
   err_t (_CALLTYPE_C *SetAttribute) (IADL_Image FAR* This, enum ADL_IMAGE_ATTRIBUTE Attribute, ADL_ATTRIBUTE_TYPE Arg);
   err_t (_CALLTYPE_C *GetAttribute) (IADL_Image FAR* This, enum ADL_IMAGE_ATTRIBUTE Attribute, ADL_ATTRIBUTE_TYPE Arg);
};
#endif
...
typedef struct IADL_Font {
   virtual err_t _CALLTYPE_C Init         ()                                                          = 0;
   virtual err_t _CALLTYPE_C SetAttribute (enum ADL_FONT_ATTRIBUTE Attribute, ADL_ATTRIBUTE_TYPE Arg) = 0;
   virtual err_t _CALLTYPE_C GetAttribute (enum ADL_FONT_ATTRIBUTE Attribute, ADL_ATTRIBUTE_TYPE Arg) = 0;
   virtual err_t _CALLTYPE_C Text         (const char *pztext, ADL_RECT *pRect, uint32_t Color)       = 0;
   virtual err_t _CALLTYPE_C TextW        (const ADL_WCHAR *pztext, ADL_RECT *pRect, uint32_t Color)  = 0;
} IADL_Font;
...
struct IADL_FontVtbl {
   ...
   err_t (_CALLTYPE_C *SetAttribute) (IADL_Font FAR* This, enum ADL_FONT_ATTRIBUTE Attribute, ADL_ATTRIBUTE_TYPE Arg);
   err_t (_CALLTYPE_C *GetAttribute) (IADL_Font FAR* This, enum ADL_FONT_ATTRIBUTE Attribute, ADL_ATTRIBUTE_TYPE Arg);
   err_t (_CALLTYPE_C *Text)         (IADL_Font FAR* This, const char *pztext, ADL_RECT *pRect, uint32_t Color);
   err_t (_CALLTYPE_C *TextW)        (IADL_Font FAR* This, const ADL_WCHAR *pztext, ADL_RECT *pRect, uint32_t Color);
};
#endif
...
typedef struct IADL_Target {
   virtual err_t _CALLTYPE_C Init         ()                                                            = 0;
   virtual err_t _CALLTYPE_C SetAttribute (enum ADL_TARGET_ATTRIBUTE Attribute, ADL_ATTRIBUTE_TYPE Arg) = 0;
   virtual err_t _CALLTYPE_C GetAttribute (enum ADL_TARGET_ATTRIBUTE Attribute, ADL_ATTRIBUTE_TYPE Arg) = 0;
} IADL_Target;
...
struct IADL_TargetVtbl {
   ...
   err_t (_CALLTYPE_C *SetAttribute) (IADL_Target FAR* This, enum ADL_TARGET_ATTRIBUTE Attribute, ADL_ATTRIBUTE_TYPE Arg);
   err_t (_CALLTYPE_C *GetAttribute) (IADL_Target FAR* This, enum ADL_TARGET_ATTRIBUTE Attribute, ADL_ATTRIBUTE_TYPE Arg);
};
...
typedef struct IADL_Display {
   virtual err_t _CALLTYPE_C Init         ()                                                             = 0;
   virtual err_t _CALLTYPE_C SetAttribute (enum ADL_DISPLAY_ATTRIBUTE Attribute, ADL_ATTRIBUTE_TYPE Arg) = 0;
   virtual err_t _CALLTYPE_C GetAttribute (enum ADL_DISPLAY_ATTRIBUTE Attribute, ADL_ATTRIBUTE_TYPE Arg) = 0;
...
struct IADL_DisplayVtbl {
   ...
   err_t (_CALLTYPE_C *SetAttribute) (IADL_Display FAR* This, enum ADL_DISPLAY_ATTRIBUTE Attribute, ADL_ATTRIBUTE_TYPE Arg);
   err_t (_CALLTYPE_C *GetAttribute) (IADL_Display FAR* This, enum ADL_DISPLAY_ATTRIBUTE Attribute, ADL_ATTRIBUTE_TYPE Arg);
   err_t (_CALLTYPE_C *TargetCreate) (IADL_Display FAR* This, IADL_Target **pTarget);
   err_t (_CALLTYPE_C *TargetDestroy)(IADL_Display FAR* This, IADL_Target **pTarget);
...
err_t ADL_EXPORT_FN ADL_DisplayCreate (IADL_Display **ppDisplay, enum ADL_IMPLEMENTATION Impl);
err_t ADL_EXPORT_FN ADL_DisplayDestroy(IADL_Display **ppDisplay, enum ADL_IMPLEMENTATION Impl);

err_t ADL_EXPORT_FN ADL_ImageCreate (IADL_Image **ppImage);
err_t ADL_EXPORT_FN ADL_ImageDestroy(IADL_Image **ppImage);

err_t ADL_EXPORT_FN ADL_GetLastError(err_t *pErrorCode, size_t *pSize, char *pszDescString);
