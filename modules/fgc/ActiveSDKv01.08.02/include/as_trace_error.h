...
typedef enum AS_TraceError {
    ...
    ,
    AS_TraceInvalidArgument /*! One of more arguments passed to the function
                               have invalid value(s). */
    ,
    AS_TraceRegistryError /*! Error whilst accessing the Windows registry. */
    ,
    AS_TraceInitialisedMaxCountReached /*! The library has been initialized too
                                          many times (current max count is 255).
                                        */
    ,
    AS_TraceAlreadyInitialised /*! The library is already initialized and is
                                  ready to be used. */
    ,
    AS_TraceNotInitialised /*! The library is not yet initialized; TraceOpen()
