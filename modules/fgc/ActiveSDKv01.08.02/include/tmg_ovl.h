...
#define ASL_MAKEFOURCC(ch0, ch1, ch2, ch3)                                     \
    ((ui32)(ui8)(ch0) | ((ui32)(ui8)(ch1) << 8) | ((ui32)(ui8)(ch2) << 16) |   \
     ((ui32)(ui8)(ch3) << 24))
#endif
...
/* Error reporting */
#define DISPLAY_ERROR(_r)                                                      \
    (ui32)(ASL_kDisplayError_##_r + (__LINE__ * ASL_kDisplayError_Locus))
...
typedef enum ASL_DisplayFlag {
    ASL_kDisplayFlagDirectToScreen =
        (1 << 0), /* r/w Hardware can display video direct to screen */
    ASL_kDisplayFlagHasOverlay =
        (1 << 1), /* r/o Graphic/text overlay supported */
    ASL_kDisplayFlagEnableOverlay = (1 << 2), /* r/w */
    ASL_kDisplayFlagBufferChaining =
        (1 << 3), /* r/w Multiple frames are stored in buffer chains */
    ASL_kDisplayFlagCanStretch = (1 << 4), /* r/o Can stretch video in h/w */
    ASL_kDisplayFlagVideoBobbing =
        (1 << 5) /* r/w Stagger odd/even fields for interlacing */
} ASL_DisplayFlag;
...
struct ASL_Display {
...
#if defined _WINDOWS /* So that console applications work - they don't have    \
                        _WINDOWS defined */
    /* DirectDraw objects */
    LPDIRECTDRAW pDD;
    ...
    LPDIRECTDRAWSURFACE
        psfcVideo; /* Live video surface, overlay or offscreen */
...
ASL_EXPORT(ui32,
           ASL_DisplayGetScanLine(                   /* Returns !0 on error */
...
ASL_EXPORT(
    ui32,
    ASL_DisplayCreate(                 /* Returns !0 on error */
                      ...
                      ASL_PTR(
                          const ASL_DisplayFormat), /* IN: Pixel format array */
                      ASL_PTR(ASL_DisplayHandle)    /* OUT: instance handle */
                      ));

/* Destroy a display */
ASL_EXPORT(ui32,
           ASL_DisplayDestroy(                  /* Returns !0 on error */
                              ASL_DisplayHandle /* IN Display to destroy */
                              ));

/* Set/get an option flag */
ASL_EXPORT(ui32,
           ASL_DisplaySetFlag(                   /* Returns !0 on error */
                              ASL_DisplayHandle, /* IN: Display instance */
                              ASL_DisplayFlag,   /* IN: flag */
                              ui32               /* IN: new state */
                              ));
ASL_EXPORT(ui32,
           ASL_DisplayGetFlag(/* 0= flag not set, 1= flag set, else error */
                              ASL_DisplayHandle, /* IN: Display instance */
                              ASL_DisplayFlag    /* IN: flag */
                              ));

ASL_EXPORT(ui32,
           ASL_DisplaySetVideoSize(                   /* Returns !0 on error */
                                   ASL_DisplayHandle, /* IN: Display instance */
                                   ui32,              /* IN: width */
                                   ui32               /* IN: height */
                                   ));
...
ASL_EXPORT(ui32,
           ASL_DisplaySetVideoRoi(                   /* Returns !0 on error */
                                  ASL_DisplayHandle, /* IN: Display instance */
...
ASL_EXPORT(ui32,
           ASL_DisplayGetVideoRoi(                   /* Returns !0 on error */
                                  ASL_DisplayHandle, /* IN: Display instance */
...
ASL_EXPORT(
    ui32,
    ASL_DisplaySetDisplayRect(                   /* Returns !0 on error */
                              ASL_DisplayHandle, /* IN: Display instance */
                              i32,               /* IN: left inclusive */
                              i32,               /* IN: top inclusive */
                              i32,               /* IN: right exclusive */
...
ASL_EXPORT(
    ui32,
    ASL_DisplayGetDisplayRect(                   /* Returns !0 on error */
                              ASL_DisplayHandle, /* IN: Display instance */
                              ASL_PTR(i32),      /* OUT: left inclusive */
                              ASL_PTR(i32),      /* OUT: top inclusive */
                              ASL_PTR(i32),      /* OUT: right exclusive */
...
ASL_EXPORT(ui32,
           ASL_DisplaySetColourKey(                   /* Returns !0 on error */
                                   ASL_DisplayHandle, /* IN: Display instance */
                                   ui8,               /* IN: red */
                                   ui8,               /* IN: green */
                                   ui8                /* IN: blue */
...
ASL_EXPORT(ui32,
           ASL_DisplayGetColourKey(                   /* Returns !0 on error */
                                   ASL_DisplayHandle, /* IN: Display instance */
                                   ASL_PTR(ui8),      /* OUT: red */
...
ASL_EXPORT(ui32,
           ASL_DisplayReleaseDC(                   /* Returns !0 on error */
                                ASL_DisplayHandle, /* IN: Display instance */
                                HDC                /* IN */
                                ));
#endif
...
ASL_EXPORT(ui32,
           ASL_DisplayFillRect(                   /* Returns !0 on error */
                               ASL_DisplayHandle, /* IN: Display instance */
                               i32,               /* IN: left inclusive */
                               i32,               /* IN: top inclusive */
                               i32,               /* IN: right exclusive */
