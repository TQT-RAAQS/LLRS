...
Terr EXPORT_FN TMG_convert_to_paletted_LUT(Thandle, Thandle,
                                           ui16); /* non-doc */
Terr EXPORT_FN TMG_convert_to_RGB24(Thandle, Thandle, ui16);
    /* non-doc */                                    /* Thread/alignment safe */
...
Terr EXPORT_FN TMG_convert_to_BGRX32(Thandle, Thandle, ui16);
    /* non-doc */ /* Thread/alignment safe */
...
Terr EXPORT_FN TMG_convert_to_BGR24(Thandle, Thandle, ui16);
    /* non-doc */ /* Thread/alignment safe */
...
Terr EXPORT_FN TMG_paletted_to_RGB24_or_Y8(Thandle, Thandle,
                                           ui16);             /* non-doc */
Terr EXPORT_FN TMG_convert_to_CMYK32(Thandle, Thandle, ui16); /* non-doc */
Terr EXPORT_FN TMG_convert_to_Y8(Thandle, Thandle, ui16);
    /* non-doc */ /* Thread/alignment safe */
Terr EXPORT_FN TMG_convert_to_Y16(Thandle, Thandle, ui16);
    /* non-doc */ /* Thread/alignment safe */
...
TMG_cnv2.c(ForBrief)
 */
Terr EXPORT_FN TMG_YUV422_to_HSI(Timage_handle Hin_image,
                                 Timage_handle Hout_image,
                                 ui16 TMG_action);           /* non-doc */
Terr EXPORT_FN TMG_YUV422_to_RGBX32(Thandle, Thandle, ui16); /* non-doc */
Terr EXPORT_FN TMG_YUV422_to_BGRX32(Thandle, Thandle, ui16);
    /* non-doc */ /* Thread/alignment safe */
Terr EXPORT_FN TMG_YUV422_to_XBGR32(Thandle, Thandle, ui16); /* non-doc */
Terr EXPORT_FN TMG_YUV422_to_XRGB32(Timage_handle Hin_image,
                                    Timage_handle Hout_image, ui16 TMG_action);
...
Terr EXPORT_FN TMG_YUV422_to_XRGB32_LUT(Timage_handle Hin_image,
                                        Timage_handle Hout_image,
                                        ui16 TMG_action);
...
Terr EXPORT_FN TMG_YUV422_to_Y8(Thandle, Thandle, ui16);
    /* non-doc */ /* Thread/alignment safe */
...
tmg_crop.c(ForBrief)
 */
Terr EXPORT_FN TMG_IP_crop(Thandle, Thandle, i32[],
                           ui16); /* Thread/alignment safe */
Terr EXPORT_FN TMG_IP_image_insert(Thandle hInImage, Thandle hInsertImage,
                                   ui32 dwX, ui32 dwY);
...
TMG_dib.c(ForBrief)
 */
Terr EXPORT_FN TMG_convert_to_DIB_w31(Thandle, Thandle, ui32,
                                      ui16);            /* non-doc */
Terr EXPORT_FN TMG_read_BMP_file(Timage_handle, ui16);  /* non-doc */
Terr EXPORT_FN TMG_write_BMP_file(Timage_handle, ui16); /* non-doc */
Terr EXPORT_FN TMG_image_write_BMP_buffer(Timage_handle Himage, ui8 *pbBuffer,
                                          ui32 *pdwByteCount, ui16 TMG_action);
...
Terr EXPORT_FN TMG_display_image(Tdisplay_handle Hdisplay, Thandle Hin_image,
                                 ui16 TMG_action);
 ...
 */
/* User functions: */
Terr EXPORT_FN TMG_display_init(Tdisplay_handle,
                                HWND); /* Thread/alignment safe */
...
tmg_dd.c(ForBrief)
 */
Terr EXPORT_FN TMG_display_direct_draw_w95(Thandle, Thandle,
                                           ui16); /* non-doc */
...
Terr EXPORT_FN TMG_display_OverlayStart(Tdisplay_handle, ui32 *, void **,
                                        ui32 *);
...
Terr EXPORT_FN TMG_display_OverlayBitBlt(ui32 hDisplay, void *pvBitmapData,
                                         i16 RoiImage[]);
Terr EXPORT_FN TMG_display_OverlayFillRegion(ui32 hDisplay, i16 RoiRect[],
                                             ui8 bRed, ui8 bGrn, ui8 bBlu);
 ...
 */
void EXPORT_FN TMG_ErrHandlerDefault(ui32 hCard, char *pszFnName,
                                     ui32 dwErrCode, char *pszDescString);
#if defined _TMG_WINDOWS || defined _TMG_MAC
ui32 EXPORT_FN TMG_ErrHandlerInstall(void (*pFnHandler)(ui32, char *, ui32,
                                                        char *));
#else /* _TMG_DOS32 & others */
ui32 EXPORT_FN TMG_ErrHandlerInstall(void(EXPORT_FN *pFnHandler)(ui32, char *,
                                                                 ui32, char *));
#endif
void EXPORT_FN TMG_ErrProcess(ui32 hLib, char *pszFnName, ui32 dwErrCode,
                              char *pszDescString);
...
Terr EXPORT_FN TMG_image_copy_parameters(Thandle,
                                         Thandle); /* Thread/alignment safe */
Terr EXPORT_FN
    TMG_image_copy_parameters_raw(Thandle, Thandle); /* Thread/alignment safe */
...
ui32 EXPORT_FN TMG_image_get_parameter(Thandle,
                                       ui16);        /* Thread/alignment safe */
...
char
    EXPORT_FN_PTR TMG_image_get_infilename(Thandle); /* Thread/alignment safe */
char EXPORT_FN_PTR
    TMG_image_get_outfilename(Thandle);           /* Thread/alignment safe */
Terr EXPORT_FN TMG_image_malloc_a_strip(Thandle); /* Thread/alignment safe */
ui32 EXPORT_FN TMG_ImageMake(ui32 hImage, i32 nWidth, i32 nHeight,
                             ui16 wPixelFormat, ui32 dwColour);
...
ui32 EXPORT_FN TMG_Util_ParseCommand(struct tTMG_Cmd *psCmd, int argc,
                                     char **argv);
...
Terr EXPORT_FN TMG_JPEG_buffer_read(Thandle Himage, ui8 *pbData,
                                    ui32 dwBytesData);
Terr EXPORT_FN TMG_JPEG_file_write(Thandle, ui16);
Terr EXPORT_FN TMG_JPEG_buffer_write(Timage_handle Hjpeg_image, ui8 *pdData,
                                     ui32 *pdwCount, ui16 TMG_action);
...
Terr EXPORT_FN TMG_JPEG_ConvertToMonoYUV(
    Thandle hJpegImage); /* By setting chrominance Q table to 255s */
...
Terr EXPORT_FN TMG_convert_to_paletted(Thandle, Thandle,
                                       ui16); /* non-doc/user */
...
TMG_scl.c(ForBrief)
 */
Terr EXPORT_FN TMG_IP_subsample(ui32 hInImage, ui32 hOutImage, int nFactor,
                                ui16 TMG_action);
Terr EXPORT_FN TMG_IP_pixel_rep(Thandle, Thandle, ui16, ui16);
Terr EXPORT_FN TMG_IP_bilinear_zoom(Thandle Hin_image, Thandle Hout_image,
                                    i32 *piRoi, ui16 XSize, ui16 YSize,
                                    ui16 *pwXCoeffs, ui16 *pwYCoeffs,
                                    ui16 TMG_action);
...
TMG_rot.c(ForBrief)
 */
Terr EXPORT_FN TMG_image_rotate(Thandle, Thandle, ui16,
                                ui16); /* Note: not in current libraries */
...
TMG_bay.c(ForBrief)
 */
Terr EXPORT_FN TMG_BAY_RGB24_to_RGGB32(Thandle Hin_image, Thandle Hout_image,
                                       ui16 TMG_action);
Terr EXPORT_FN TMG_BAY_RGGB32_map_to_RGB24(Thandle Hin_image,
                                           Thandle Hout_image, int nPixelOrigin,
                                           ui16 TMG_action);
Terr EXPORT_FN TMG_BAY_RGGB32_map_to_Y8(Thandle Hin_image, Thandle Hout_image,
                                        ui16 TMG_action);
Terr EXPORT_FN TMG_BAY_RGGB32_to_BGRX32(Thandle Hin_image, Thandle Hout_image,
                                        int nDecodeScheme, int nTopLeftPixel,
                                        ui16 TMG_action);
Terr EXPORT_FN TMG_BAY_RGGB32_to_RGB16(Thandle Hin_image, Thandle Hout_image,
                                       ui16 wDecodeScheme, ui16 wPixelCol,
                                       ui16 TMG_action);
Terr EXPORT_FN TMG_BAY_ColorBalance(Thandle hInImage, Thandle hOutImage, ui8 bR,
                                    ui8 bG, ui8 bB, ui16 TMG_action);
...
TMG_draw.c(ForBrief)
 */
Terr EXPORT_FN TMG_DrawText(Thandle hImage, char *pszString,
                            struct sTMG_Font *psTmgFont, i32 nX, i32 nY,
                            ui32 dwMode, ui32 dwColour);

Terr EXPORT_FN TMG_draw_get_ptr(ui32 dwType, void **ppData);
Terr EXPORT_FN TMG_draw_text(Thandle hImage, char *pszString,
                             struct sTMG_Font *psTmgFont, ui32 dwX, ui32 dwY,
                             ui32 dwMode, ui32 dwColour);
Terr EXPORT_FN TMG_draw_timestamp(Thandle hImage, struct sTMG_Font *psTmgFont,
                                  ui32 dwX, ui32 dwY, ui32 dwMode,
                                  ui32 dwColour);
ui32 EXPORT_FN TMG_DrawPixel(ui32 hImage, ui32 dwColour, i32 nX, i32 nY);
Terr EXPORT_FN TMG_DrawCircle(ui32 hImage, i32 nX, i32 nY, i32 nRadius,
                              ui32 dwColor, ui32 dwThickness, ui32 dwMode);
Terr EXPORT_FN TMG_DrawLine(ui32 hImage, i32 nX1, i32 nY1, i32 nX2, i32 nY2,
                            ui32 dwColor, ui32 dwThickness, ui32 dwMode);
Terr EXPORT_FN TMG_DrawBox(ui32 hImage, i32 nX1, i32 nY1, i32 nX2, i32 nY2,
                           ui32 dwColor, ui32 dwThickness, ui32 dwMode);
Terr EXPORT_FN TMG_DrawBoxFill(ui32 hImage, i32 nX1, i32 nY1, i32 nX2, i32 nY2,
                               ui32 dwColor, ui32 dwMode);
...
TMG_spl.c(ForBrief)
 */
Terr EXPORT_FN TMG_IP_ShadingCorrection_Generate(ui32 hBlackRefImage,
                                                 ui32 hWhiteRefImage,
                                                 ui32 hOffsetImage,
                                                 ui32 hGainImage);
Terr EXPORT_FN TMG_IP_ShadingCorrection(ui32 hInImage, ui32 hOutImage,
                                        ui32 hOffsetImage, ui32 hGainImage);
Terr EXPORT_FN TMG_IP_extract_region(Thandle Hin_image, Thandle Hout_image,
                                     ui32 dwRegionType, ui32 dwX, ui32 dwY,
                                     ui32 dwRadius, ui16 TMG_action);
Terr EXPORT_FN TMG_IP_filter_3x3(Thandle, Thandle, i32 *, ui16);
Terr EXPORT_FN TMG_IP_generate_averages(Thandle Hin_image,
                                        struct tTMG_Averages *psAverages,
                                        ui16 TMG_action);
Terr EXPORT_FN TMG_IP_histogram_clear(struct tTMG_Histogram *psHistogram);
Terr EXPORT_FN TMG_IP_histogram_copy(struct tTMG_Histogram *psHistogramIn,
                                     struct tTMG_Histogram *psHistogramOut);
Terr EXPORT_FN TMG_IP_histogram_filter(struct tTMG_Histogram *psInHistogram,
                                       i32 nFilterOrder);
Terr EXPORT_FN TMG_IP_histogram_generate(Thandle Hin_image,
                                         struct tTMG_Histogram *psHistogram,
                                         ui16 TMG_action);
Terr EXPORT_FN TMG_IP_histogram_match(struct tTMG_Histogram *psRefHistogram,
                                      struct tTMG_Histogram *psInHistogram,
                                      i32 n32Plane, ui32 *pdwResult);
Terr EXPORT_FN TMG_IP_mirror(Thandle hInImage, Thandle hOutImage, i32 *roi,
                             ui16 TMG_action);
Terr EXPORT_FN TMG_IP_mirror_image(Thandle, Thandle, ui16);
Terr EXPORT_FN TMG_IP_motion_detect(Thandle hCurrentImage, Thandle hLastImage,
                                    i32 nThreshold, i32 nStride,
                                    i32 *pnPercentChange);
Terr EXPORT_FN TMG_IP_rotate_image(Thandle, Thandle, ui32);
Terr EXPORT_FN TMG_IP_scale(Thandle Hin_image, Thandle Hout_image,
                            ui32 dwNewWidth, ui32 dwNewHeight, ui16 TMG_action);
...
Terr EXPORT_FN TMG_SPL_Data32_to_Y8(Thandle Hin_image, Thandle Hout_image,
                                    ui16 wShiftRight, ui16 TMG_action);
Terr EXPORT_FN TMG_SPL_field_to_frame(ui32 hInImage, ui32 hOutImage,
                                      ui16 wInterpScheme, ui16 TMG_action);
Terr EXPORT_FN TMG_SPL_HSI_to_RGB_pseudo_colour(Thandle Hin_image,
                                                Thandle Hout_image,
                                                ui16 TMG_action);
...
Terr EXPORT_FN TMG_SPL_YUV422_to_RGB_pseudo_colour(Thandle Hin_image,
                                                   Thandle Hout_image,
                                                   ui16 TMG_action);
...
Terr EXPORT_FN TMG_CK_chroma_key(Thandle, Thandle, Thandle, ui16, Thandle, ui16,
                                 ui16);
 ...
 */
ui32 EXPORT_FN TMG_MJPEG_Create(ui32 *pdwHandle, char *pszFilename,
                                i32 nCameraNumber, i32 nQFactor);
...
ui32 EXPORT_FN TMG_MJPEG_BufferWrite(Timage_handle Hjpeg_image, ui8 *pbData,
                                     ui32 *pdwCount, ui8 *pszCommentString);
ui32 EXPORT_FN TMG_MJPEG_DEBUG_DumpData(struct tTMG_MJPEG *psMJPEG,
                                        char *pszFilename);
...
#if defined _TMG_WINDOWS
INT TMG_CriticalSectionhandler(LPEXCEPTION_POINTERS pExceptionRecord,
                               const char *szFnName);
