...
class __declspec(dllexport) CPcc {
  ...
  public:
    ...
    CPcc(CWnd *pParentView,
         void (*pFnErrorHandler)(const char *, etStat, const char *));
    CPcc(CWnd *pParentView, unsigned long dwPagesVisible,
         void (*pFnErrorHandler)(const char *, etStat, const char *));
    CPcc(CWnd *pParentView, unsigned long dwPagesVisible, tFlag fPushDocTitle,
         void (*pFnErrorHandler)(const char *, etStat, const char *));
    ~CPcc();
