...
#ifdef WIN32
/* Trace not ready for linux yet, but just a matter of using the right timing functions */
#include <windows.h>
...
#define SETUP_TRACE LARGE_INTEGER lastCallCounter2; \
   float currTime; \
...
#define END_TRACE(var) QueryPerformanceCounter(&newCounter); \
   currTime = (float(newCounter.QuadPart - lastCallCounter2.QuadPart)/perfFreq.QuadPart)*1000.0f; \
