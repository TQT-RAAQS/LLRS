#ifndef _ACTIVESILICON_1XCLD_HPP
#define _ACTIVESILICON_1XCLD_HPP
...
namespace Acquisition {
    ...
    /*
     * Begins the acquisition process. After the call, control is returned to this 
     * application. Use PHX_check_and_wait to check if an image is ready to be acquired.
     * This function should be called before calling get_current_buffer, and the 
     * program should always end with a call to stop_stream_read.
     */
    void start_stream_read();

    /*
     * Stops the acquisition process after the current image is acquired. 
     * This function should always be called after the necessary images are acquired.
     */
    ...
    /*
     * Waits indefinitely for an event to occur. Only return control to the user's 
     * application when an event occurs or times out.
     */
