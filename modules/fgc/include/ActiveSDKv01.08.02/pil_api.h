...
etStat PHX_EXPORT_FN PIL_FieldToFrame( tPHX, tPHX, etPilInterpolation, tFlag fFirstField );
etStat PHX_EXPORT_FN PIL_FileWrite   ( tPHX, char* pszFileName, etPilFileFormat eFileFormat );
