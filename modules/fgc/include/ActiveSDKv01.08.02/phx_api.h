...
typedef enum {
   ...
   PHX_ACQ_BUFFER_MEMSET_MODE    = (int) ((ui32) PHX_FBD_SETANDGET | ((ui32) 113 << 8 )),
   PHX_ACQ_BUFFER_MEMSET_VALUE   = (int) ((ui32) PHX_FBD_SETANDGET | ((ui32) 114 << 8 )),
...
etStat PHX_EXPORT_FN PHX_CameraConfigLoad( tHandle*, char*, etCamConfigLoad, void (PHX_C_CALL *) (const char*, etStat, const char*) );
