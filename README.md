...
The AWG configuration can be found at `configs/awg/trapping.yml`. This file contains the configuration for the AWG-related parameters, e.g., the nominal peak-to-peak voltage, the sampling rate, and the number of segments.
...
1. Keep track of the nominal peak-to-peak voltage configured for the AWG channel you wish to calibrate at `config/awg/trapping.yml`.
